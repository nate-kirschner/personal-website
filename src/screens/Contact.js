...
export default function Contact({ headerClicked, allRefs, scrollToPage }) {
  ...
  return (
    <div className="contact" ref={allRefs["Contact"]}>
      <Header
        title="Contact"
        clicked={(blurOn) => headerClicked(allRefs["Contact"], blurOn)}
        allRefs={allRefs}
        scrollToPage={scrollToPage}
      />
      <div
        className="contactBox email"
        ref={fadeInRefs.email}
        id={isVisible.email ? "inView" : "outView"}
      >
        <a
          className="contactLink"
          href="mailto:nmkirschner@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <div
        className="contactBox linkedin"
        ref={fadeInRefs.linkedin}
        id={isVisible.linkedin ? "inView" : "outView"}
      >
        <a
          className="contactLink"
      ...
      <div
        className="contactBox github"
        ref={fadeInRefs.github}
        id={isVisible.github ? "inView" : "outView"}
      >
        <a
          className="contactLink"
